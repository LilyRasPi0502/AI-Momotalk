...
function PageSelect(Item){
	...
	if(Item == 0){		//查看個人檔案
		...
		if(!mobile())   document.getElementById("StudentProfile").innerHTML = '<div id="Chat" class="Chat">Chat</div>';
		document.getElementById("SetIcon").style.filter = "opacity(0.5)";
		if(!mobile())   document.getElementById("Chat").innerHTML = "";
	}
	else if(Item == 1){	//查看聊天
	    if(mobile())    document.getElementById("MainPage").innerHTML = '<div class="StudentListTitle"><div id="StudentCount" class="StudentCount font"></div><div id="Filter" class="Filter font" onclick="Filter();">默認</div><div class="FilterAllow"></div><div class="Reverse font" onclick="Reverse();">≡<image src="img/ReverseButton0.png" id="Reverse"><input type="hidden" id="ReverseAllow" value="0"></div></div><div id="StudentListPanel" class="StudentListPanel"></div>';
	    ...
	    if(mobile())    document.getElementById("MainPage").innerHTML = '<div id="StudentListPanel" class="StudentListPanel"></div>';
		document.getElementById("PageProfile").src = "img/PageProfile1.png";
		document.getElementById("PageChat").src = "img/PageChat1.png";
	    ...
	    if(mobile())    document.getElementById("MainPage").innerHTML = '<div id="StudentProfile" class="StudentProfile font"><div id="Chat" class="Chat">Chat</div></div>';
		document.getElementById("PageProfile").src = "img/PageProfile1.png";
		document.getElementById("PageChat").src = "img/PageChat0.png";
...
function ViewSetting(){
	if(!mobile())   document.getElementById("StudentList").innerHTML = '<div id="StudentListPanel" class="StudentListPanel"></div>';
	...
	Str += '<div class="SettingBox"><span style="font-size:30px;">背景音樂</span><label class="switch"><input type="checkbox" id="MuteCB"'+ Mute +' onclick="OnSetting(0);"><span class="slider round"></span></label></div>';
	
	// 色色 Switch
	if(coojson.Sex)	Sex = " checked";
	else			Sex = "";
	Str += '<div class="SettingBox" onchange="OnSetting(1);"><span style="font-size:30px;">我要色色</span><label class="switch"><input type="checkbox"'+ Sex +' id="SexCB""><span class="slider round"></span></label></div>';
	...
	// 版本號
	Str += '<div class="SettingBox"><span style="font-size:30px;">Version:\t'+ version +'</span></div>';
